...
-- CreateIndex
CREATE INDEX "Buyer_ownerId_city_idx" ON "public"."Buyer"("ownerId", "city");

-- CreateIndex
CREATE INDEX "Buyer_ownerId_propertyType_idx" ON "public"."Buyer"("ownerId", "propertyType");

-- CreateIndex
CREATE INDEX "Buyer_ownerId_status_idx" ON "public"."Buyer"("ownerId", "status");

-- CreateIndex
CREATE INDEX "Buyer_ownerId_timeline_idx" ON "public"."Buyer"("ownerId", "timeline");

-- CreateIndex
CREATE INDEX "Buyer_ownerId_updatedAt_idx" ON "public"."Buyer"("ownerId", "updatedAt");
